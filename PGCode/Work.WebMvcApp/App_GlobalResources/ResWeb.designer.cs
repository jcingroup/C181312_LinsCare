...
namespace Resources {
    ...
    internal class ResWeb {
        ...
        /// <summary>
        ///   查詢類似 好健康是一家早期移民紐西蘭的台灣家庭，希望把以農立國全球公認青山綠水零污染的紐西蘭產品，引進分享給更多台灣鄉親的進口兼代理公司。代理產品：牛初乳奶粉、麥盧卡蜂蜜、麥盧卡蜂蜜酒、Nice &amp; Natural 營養棒、Hubbards 燕麥片、Vogel&apos;s 燕麥片。 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 牛初乳, 牛初乳奶粉, 麥盧卡蜂蜜, UMF, manuka, 麥盧卡蜂蜜酒, 蜂蜜蒸餾酒, 蜜酒, 營養棒, 燕麥片, Nice &amp; Natural, Hubbards, Vogel&apos;s, 紐西蘭, 好健康 的當地語系化字串。
        /// </summary>
